...
set PIPELINE_SPOTIFY_RPS=%PIPELINE_SPOTIFY_RPS%
if "%PIPELINE_SPOTIFY_RPS%"=="" set PIPELINE_SPOTIFY_RPS=1.0

set PIPELINE_PLAYLIST_DELAY_MIN=%PIPELINE_PLAYLIST_DELAY_MIN%
if "%PIPELINE_PLAYLIST_DELAY_MIN%"=="" set PIPELINE_PLAYLIST_DELAY_MIN=0.5

set PIPELINE_PLAYLIST_DELAY_MAX=%PIPELINE_PLAYLIST_DELAY_MAX%
if "%PIPELINE_PLAYLIST_DELAY_MAX%"=="" set PIPELINE_PLAYLIST_DELAY_MAX=1.5
...
python scripts\run_full_cnn_pipeline.py ^
  ...
  --requests-per-second %PIPELINE_SPOTIFY_RPS% ^
  --playlist-delay-min %PIPELINE_PLAYLIST_DELAY_MIN% ^
  --playlist-delay-max %PIPELINE_PLAYLIST_DELAY_MAX% ^
